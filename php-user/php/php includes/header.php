...
<body>
    <div>
        ...
        <section class="dashboard-section1 bg-light">
            <div class="container-fluid container1">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container">
                      <a class="navbar-brand text-primary nav-bar-navbar-brand" href="dashboard.html">AEE</a>
                      ...
                      <div class="justify-content-end align-items-center text-center collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                          <li class='nav-item <?php echo ($page1 == "dashboard.php" ? "btn btn-sm btn-outline-primary" : "");?>'>
                            <a id="nav1" class="nav-link "  href="dashboard.php" >Dashboard</a>
                          </li>
                          <li class='nav-item <?php echo ($page1 == "myprofile.php" ? "btn btn-sm btn-outline-primary" : "");?>' >
                            <a id="nav1" class="nav-link box3" href="myprofile.php">My Profile</a>
                          </li>
                          <li  class='nav-item <?php echo ($page1 == "myaccount.php" ? "btn btn-sm btn-outline-primary" : "");?>' >
                            <a id="nav1" class="nav-link box2" href="myaccount.php">My Account</a>
                          </li>
                          <li  class='nav-item <?php echo ($page1 == "makepayment.php" ? "btn btn-sm btn-outline-primary" : "");?>'>
