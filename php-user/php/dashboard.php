                    ...
                    <?php 
                        ...
                        <div class="col-sm-6 text-center">
                            <div class="row align-items-center">
                                <div class="container col-sm-6">
                                    <div class="container ">
                                        <img src="<?php if(isset($profile_picture)){ echo $profile_picture;} ?>" name="profile_picture" alt="profile picture" class="text-primary profile-picture img  img-fluid"><br>
                                        </div>
                                </div>
                                <div class="col-sm-6 customer-details">
                                    <h3><span class="text-secondary mt-5 mb-5">Welcome:<br></span><span class="user-name"> <?php if(isset($name)) echo $name;  ?></span></h3>
                        ...
                        <div class="glow-container ">
                            <div class="glow bg-primary">
                                <h1 class="price-per-watt text-light text-center"><?php 
                            ...
                            <p class="text-center btn btn-outline-primary mt-3">Price per watt</p>
                        </div>
                    </div>
